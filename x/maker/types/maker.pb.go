...
type BackingRiskParams struct {
	...
	MaxMerMint *github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,4,opt,name=max_black_mint,json=maxMerMint,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"max_black_mint,omitempty"`
	// mint fee rate
...
type TotalBacking struct {
	...
	MerMinted types.Coin `protobuf:"bytes,2,opt,name=black_minted,json=blackMinted,proto3" json:"black_minted"`
...
type PoolBacking struct {
	// total minted black; negative value means burned black
	MerMinted types.Coin `protobuf:"bytes,1,opt,name=black_minted,json=blackMinted,proto3" json:"black_minted"`
	// total backing
...
type TotalCollateral struct {
	...
	// interest
	MerDebt types.Coin `protobuf:"bytes,1,opt,name=black_debt,json=blackDebt,proto3" json:"black_debt"`
...
type PoolCollateral struct {
	...
	// total existing black debt, including minted by collateral, mint fee, last
	// interest
	MerDebt types.Coin `protobuf:"bytes,2,opt,name=black_debt,json=blackDebt,proto3" json:"black_debt"`
	// total collateralized fury
...
type AccountCollateral struct {
	...
	MerDebt types.Coin `protobuf:"bytes,3,opt,name=black_debt,json=blackDebt,proto3" json:"black_debt"`
	// total collateralized fury
