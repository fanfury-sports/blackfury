...
func (suite *KeeperTestSuite) TestVeDelegate() {
	...
	testCases := []struct {
		...
		{"invalid validator address", false, delAcct.String(), "blackvaloper1mnfm9c7cdgqnkk66sganp78m0ydmcr4pctrjrx", "ve-100", sdk.NewCoin(denom, sdk.NewInt(100))},
		{"validator not found", false, delAcct.String(), "blackvaloper1mnfm9c7cdgqnkk66sganp78m0ydmcr4pctrjr3", "ve-100", sdk.NewCoin(denom, sdk.NewInt(100))},
		{"invalid delegator address", false, "black1mnfm9c7cdgqnkk66sganp78m0ydmcr4ppeaeg2", suite.validator.GetOperator().String(), "ve-100", sdk.NewCoin(denom, sdk.NewInt(100))},
...
func (suite *KeeperTestSuite) TestBeginRedelegate() {
	...
	valSrcAddr := "blackvaloper1mnfm9c7cdgqnkk66sganp78m0ydmcr4pctrjr3"
	valDestAddr := "blackvaloper1353a4uac03etdylz86tyq9ssm3x2704j6g0p55"
	...
	testCases := []struct {
		...
		{"invalid validator src address", false, delAcct.String(), "blackvaloper1mnfm9c7cdgqnkk66sganp78m0ydmcr4pctrjrx", suite.validator.GetOperator().String(), sdk.NewCoin(denom, sdk.NewInt(100))},
		{"invalid delegator address", false, "black1mnfm9c7cdgqnkk66sganp78m0ydmcr4ppeaeg2", suite.validator.GetOperator().String(), suite.validator.GetOperator().String(), sdk.NewCoin(denom, sdk.NewInt(100))},
		{"invalid coin denomination", false, delAcct.String(), valSrc.String(), valDest.String(), sdk.NewCoin("denom", sdk.NewInt(100))},
		{"invalid validator dst address", false, delAcct.String(), valSrc.String(), "blackvaloper1mnfm9c7cdgqnkk66sganp78m0ydmcr4pctrjrx", sdk.NewCoin(denom, sdk.NewInt(100))},
...
func (suite *KeeperTestSuite) TestUndelegate() {
	...
	testCases := []struct {
		...
		{"invalid validator address", false, delAcct.String(), "blackvaloper1mnfm9c7cdgqnkk66sganp78m0ydmcr4pctrjrx", sdk.NewCoin(denom, sdk.NewInt(100))},
		{"invalid delegator address", false, "black1mnfm9c7cdgqnkk66sganp78m0ydmcr4ppeaeg2", suite.validator.GetOperator().String(), sdk.NewCoin(denom, sdk.NewInt(100))},
